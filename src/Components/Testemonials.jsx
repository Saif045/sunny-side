...
const [ data ,setData  ] =useState(testemonials)
  return (
    <div className='m-6 xs:m-14 sm:m-10 md:m-20 lg:m-40'>
      ...
      <div className='text-gray-500 font-semibold text-center mb-10'>
        ...
        <div className='grid sm:grid-cols-3 gap-16 sm:gap-6 '>
          ...
          <div className='flex flex-col  items-center '>
            <img className='w-10 sm:w-16 object-cover rounded-full ' src={emily}/>
          ...
          <div className='flex flex-col  items-center '>
            <img className='w-10 sm:w-16 object-cover rounded-full ' src={thomas}/>
          ...
          <div className='flex flex-col  items-center '>
            <img className='w-10 sm:w-16 object-cover rounded-full ' src={jennie}/>
